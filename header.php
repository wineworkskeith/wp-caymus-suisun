...
<html <?php language_attributes(); ?> class="no-js">
	...
	<body <?php body_class(); ?> id="top">
		...
		<button href="#" class="menu-toggle" id="mobile-menu-toggle" >
		...
		<header class="header">
			<div class="content-wrapper">
				<a href="/" class="header__logo" title="Caymus Vineyards">
					<?php get_template_part('template-parts/svgs/logo-black'); ?>
				</a><!--logo-->
				<nav class="header__logos" role="dialog">
					<ul>
						<?php
						if(have_rows('brands_bar','option')){
							while(have_rows('brands_bar','option')){
								the_row();
		...
		<script>    !function(t,o,c,k){if(!t.tock){var e=t.tock=function(){e.callMethod?    e.callMethod.apply(e,arguments):e.queue.push(arguments)};t._tock||(t._tock=e),    e.push=e,e.loaded=!0,e.version='1.0',e.queue=[];var f=o.createElement(c);f.async=!0,    f.src=k;var g=o.getElementsByTagName(c)[0];g.parentNode.insertBefore(f,g)}}(    window,document,'script','https://www.exploretock.com/tock.js');    tock('init', 'caymusrutherford');    </script>
